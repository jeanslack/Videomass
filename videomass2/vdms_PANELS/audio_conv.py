...
class Audio_Conv(wx.Panel):
    ...
    def __init__(self, parent, ffmpeg_link, threads, 
        ...
        self.btn_analyzes.SetToolTipString(_(u"Calculates the maximum and "
                                             u"average peak level of audio "
                                             u"streams expressed in dB values")
                                              )
        ...
        for files in file_sources:
            ...
            if audio_list == None:
                ...
                dlg = wx.SingleChoiceDialog(self, 
                        _(u"{0}\n\n"
                          u"Contains multiple audio streams. " 
                          u"Select which audio stream you want to "
                          u"export between these:").format(title), 
