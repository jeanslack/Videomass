...
class MainFrame(wx.Frame):
    ...
    def __init__(self, setui, DATAconf, 
        ...
        self.btn_playO.SetToolTipString(_(u"Play a file exported in the "
                                          u"last encoding."
                                        ))
...
############################### BUILD THE MENU BAR  ########################
    ...
    def CheckNewReleases(self, event):
        ...
        try:
            ...
            f = urllib.urlopen(u'https://pypi.org/project/videomass/',
                                       context=context
                                       )
            #f = urllib.urlopen(
                            #u'https://test.pypi.org/project/videomass/',
                            #context=context
                                       #)
            myfile = f.read()
