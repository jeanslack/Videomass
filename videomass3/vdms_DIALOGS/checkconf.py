...
#########################################################
# Name: checkconf.py
# Porpose: verify the build configuration of the FFmpeg
...
class Checkconf(wx.Dialog):
    """
    Check the FFmpeg build configuration and place it in an ordered list
    """
    def __init__(self, parent):
        ...
        label1 = wx.StaticText(panel, wx.ID_ANY, 'FFmpeg')
        label2 = wx.StaticText(panel, wx.ID_ANY, ffmpeg)
        self.button_1 = wx.Button(self, wx.ID_CANCEL, "")
        self.button_2 = wx.Button(self, wx.ID_OK, "")
        
        #----------------------Properties----------------------#
        self.SetTitle("Videomass: check the FFmpeg build configuration")
