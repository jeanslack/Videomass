...
class VideoRotate(wx.Dialog):
    ...
    def __init__(self, parent, orientation, msg):
        ...
        self.button_up = wx.Button(self, wx.ID_ANY, (_("Flip over"))) # capovolgi Sopra
        self.button_left = wx.Button(self, wx.ID_ANY, (_("Rotate Left"))) # ruota sx
        self.button_right = wx.Button(self, wx.ID_ANY, (_("Rotate Right"))) # ruota a destra
        self.button_down = wx.Button(self, wx.ID_ANY, (_("Flip below"))) # capovolgi sotto
        ...
        sizerLabel = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, (
                                    _("Orientation points"))), wx.VERTICAL)
        btn_close = wx.Button(self, wx.ID_CANCEL, "")
        self.btn_ok = wx.Button(self, wx.ID_OK, "")
        btn_reset = wx.Button(self, wx.ID_CLEAR, "")
        #----------------------Properties------------------------------------#

        self.SetTitle(_("Videomass2: Set Video/Image Rotation"))
...
class VideoResolution(wx.Dialog):
    ...
    def __init__(self, parent, scale, dar, sar):
        ...
        v_setdar = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, (
                                    _("Setdar (display aspect ratio):"))), wx.VERTICAL)
        ...
        v_setsar = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, (
                                    _("SetSar (sample aspect ratio):"))), wx.VERTICAL)
       ...
       # Flex_scale_base.Add(Flex_scale)
        ...
        # Properties
        self.SetTitle(_("Videomass2: Resize (change resolution)"))
...
class Lacing(wx.Dialog):
    ...
    def __init__(self, parent, deinterlace, interlace):
        ...
        self.ckbx_deintW3fdif = wx.CheckBox(self, wx.ID_ANY, 
                                (_("Deinterlaces (Using the 'w3fdif' filter)"))
                                            )
        self.rdbx_W3fdif_filter = wx.RadioBox(self, wx.ID_ANY, 
                                              ("Filter"), choices=[("simple"),
                                              ("complex")],
                                            majorDimension=0, 
        ...
        self.ckbx_deintYadif = wx.CheckBox(self, wx.ID_ANY, 
                                (_("Deinterlaces (Using the 'yadif' filter)"))
                                            )
        self.rdbx_Yadif_mode = wx.RadioBox(self, wx.ID_ANY, 
                                            ("Mode"), choices=[("0, send_frame"),
                                            ("1, send_field"),
        ...
        self.ckbx_interlace = wx.CheckBox(self, wx.ID_ANY,
                            (_("Interlaces (Using the 'interlace' filter)"))
                                          )
        ...
        # set Properties
        self.SetTitle(_("Videomass2: Deinterlace/Interlace"))
        ...
        self.rdbx_W3fdif_filter.SetToolTip(_('Set the interlacing filter '
                                                 'coefficients.')
                                                 )
        self.rdbx_W3fdif_deint.SetToolTip(_('Specify which frames to '
                                                'deinterlace.')
                                                  )
        self.ckbx_deintYadif.SetToolTip(_('Deinterlace the input video '
        ...
        self.rdbx_Yadif_parity.SetToolTip(_('parity\n'
...
class Denoisers(wx.Dialog):
    ...
    def __init__(self, parent, denoiser):
        ...
        # set Properties
        self.SetTitle(_("Videomass2: Denoisers filters"))
        ...
        self.ckbx_hqdn3d.SetToolTip(_('hqdn3d:\n '
