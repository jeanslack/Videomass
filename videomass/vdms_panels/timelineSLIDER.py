...
class Timeline(wx.Panel):
    ...
    def __init__(self, parent, iconedit):
        ...
        self.milliseconds: int(milliseconds) media total duration in ms
    ...
    def on_Cut(self, event):
        ...
        self.sldseek.SetMax(self.sldseek.GetValue() + cut)  # seek offset
    ...
    def on_Seek(self, event):
        ...
        self.sldcut.SetMin(seek)
        self.sldseek.SetMax(self.sldcut.GetValue())  # seek offset

        #self.sldcut.SetMax(self.milliseconds - seek)  # cut offset
        time = milliseconds2clock(seek)  # convert to 24-hour clock
        dur = milliseconds2clock(self.sldcut.GetValue() - seek)
        self.parent.time_seq = f"-ss {time} -t {dur}"
    ...
    def onRedraw(self, event):
        ...
        #if end:
            #dc.DrawRectangle(self.bar_x + 1, -8, 0, 66)
        #elif dur:
            #dc.DrawRectangle(50 + 1, -8, self.bar_w, 66)
        #else:
            #dc.DrawRectangle(self.bar_x + 1, -8, self.bar_w, 66)

        #dc.DrawRectangle(50 + 1, -8, 89-50, 66)
        #dc.DrawRectangle(0 + 1, -8, 89-0, 66)
        dc.DrawRectangle(self.bar_x + 1, -8, self.bar_w, 66)
