...
class VideoRotate(wx.Dialog):
    ...
    def on_up(self, event):
        self.orientation = "'vflip, hflip' -metadata:s:v rotate=0"
        self.text_rotate.SetValue("180° from bottom to top")
        
    #------------------------------------------------------------------#
    def on_left(self, event):
        opt = "'transpose=1,transpose=1,transpose=1' -metadata:s:v rotate=0"
        self.orientation = opt
        self.text_rotate.SetValue("Rotate 90° Left")
        
    #------------------------------------------------------------------#
    def on_right(self, event):
        self.orientation = "'transpose=1' -metadata:s:v rotate=0"
        self.text_rotate.SetValue("Rotate 90° Right")
        
    #------------------------------------------------------------------#
    def on_down(self, event):
        self.orientation = "'hflip, vflip' -metadata:s:v rotate=0"
