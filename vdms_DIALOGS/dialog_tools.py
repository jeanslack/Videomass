...
class SaveImages(wx.Dialog):
    ...
    def __init__(self, parent, hasSet, vrate):
        ...
        self.stop_second_ctrl.SetToolTipString("Minutes amount duration")
        self.stop_minute_ctrl.SetToolTipString("Seconds amount duration")
        self.combo_box.SetMinSize((70, -1))
        ...
        grid_sizer_3.Add(sizer_5, 1, wx.ALL | wx.EXPAND, 5)
        ...
        grid_sizer_3.Add(sizer_6, 1, wx.ALL | wx.EXPAND, 5)
        grid_sizer_2.Add(grid_sizer_3, 1, wx.EXPAND, 0)
        sizer_7.Add(self.combo_box, 0, wx.ALL| wx.CENTER, 5)
        grid_sizer_2.Add(sizer_7, 1, wx.ALL |wx.ALIGN_CENTER_VERTICAL, 5)
        grid_sizer_1.Add(grid_sizer_2, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_6.Add(btn_close, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5)
        grid_sizer_6.Add(self.btn_ok, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5)
        grid_sizer_6.Add(btn_reset, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5)
